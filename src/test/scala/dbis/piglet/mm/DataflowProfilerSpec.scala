...
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m1", None, 10, 100, 100))
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m2", Some("m1"), 20, 80, 50))
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m3", Some("m2"), 40, 60, 40))
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m2", Some("m1"), 20, 80, 50))
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m4", Some("m3"), 15, 70, 60))
//    DataflowProfiler.addMaterializationPoint(MaterializationPoint("m2", Some("m1"), 20, 80, 50))
//
//    val om1 = DataflowProfiler.getMaterializationPoint("m1")
...
//
//    val om2 = DataflowProfiler.getMaterializationPoint("m2")
...
//
//    val om3 = DataflowProfiler.getMaterializationPoint("m3")
...
//
//    val om4 = DataflowProfiler.getMaterializationPoint("m4")
