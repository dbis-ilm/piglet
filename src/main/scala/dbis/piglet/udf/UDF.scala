...
object UDFTable {
  lazy val funcTable = ListBuffer[UDF](
    ...
    UDF("MEDIAN", "PigFuncs.median", List(Types.IntType), Types.DoubleType, isAggregate = true),
    UDF("MEDIAN", "PigFuncs.median", List(Types.LongType), Types.DoubleType, isAggregate = true),
    UDF("MEDIAN", "PigFuncs.median", List(Types.FloatType), Types.DoubleType, isAggregate = true),
    UDF("MEDIAN", "PigFuncs.median", List(Types.DoubleType), Types.DoubleType, isAggregate = true),
