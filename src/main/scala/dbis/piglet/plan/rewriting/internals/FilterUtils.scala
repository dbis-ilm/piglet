...
object FilterUtils {
  /** Extract the [[dbis.piglet.op.Predicate]] from one. This also extracts the Predicate from a [[dbis.piglet.op.PPredicate]]
    */
  ...
  /** Extract all the [[dbis.piglet.op.Ref]] values used in a [[dbis.piglet.op.Expr]].
    */
  ...
  /** Find a [[dbis.piglet.op.PigOperator]] whose schema contains all the fields of ``namedFields``.
    */
